...
//if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
    ...
    // $mail->addAddress( "teaminvest@vidalia.com.ph" , "Vidalia Investment" );
    $mail->addAddress( "joyce@molavenet.com" , "Vidalia Investment" );
    ...
    $mail->Body = "
        ...
        $forapplicantmail->addReplyTo( "joyce@molavenet.com", "Vidalia Investment" );
        ...
        <div> 
            <div>
                <p>Your placement has been submitted, Thank you!</p>
