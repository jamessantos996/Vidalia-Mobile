...
//if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
    ...
    */
    ...
    $mail = new PhpMailer;
    $mail->CharSet = 'UTF-8';
    $mail->From = 'investment@vidalia.com.ph';
    $mail->addReplyTo( $email, $name );
    $mail->FromName = "Vidalia Lending";
    $mail->addAddress( "teaminvest@vidalia.com.ph" , "Vidalia Lending" );     // Add a recipient
    ...
    $mail->Body = "
        ...
        $forapplicantmail->addReplyTo( "teaminvest@vidalia.com.ph", "Vidalia Lending" );
        $forapplicantmail->FromName = "Vidalia Lending.";
        $forapplicantmail->addAddress( $email , "Vidalia Lending" );     // Add a recipient
