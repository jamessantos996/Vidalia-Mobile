...
if ($agree != "agree") {
    ...
    if ($typeOfLoan == "Personal") {
        ...
        if ($city == "Others") {
            ...
            $mail->addReplyTo($email, $fname . " " . $mname . " " . $lname);
            $mail->FromName     = $fname . " " . $mname . " " . $lname;
            $mail->addAddress('joyce@molavenet.com', "Vidalia Lending Corp."); // Add a recipient
            $mail->isHTML(true); // Set email format to HTML
            $mail->Subject      = $subject;
            $first_half_message = "
            <div>
            ...
            $mailForApplicant->From     = 'joyce@molavenet.com';
            $mailForApplicant->FromName = "Vidalia Lending Corp.";
            $mailForApplicant->addReplyTo('joyce@molavenet.com', "Vidalia Lending Corp.");
