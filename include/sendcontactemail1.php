...
$mail->addAddress( "hazel@molavenet.com" , "Vidalia Lending Corporation" );     // Add a recipient
...
$mail->Body    = " <div> 
                    <h3 style='padding:10px 0;color:#DFA128; font-weight: 700;'><b>Submitted Details:</b></h3>
                </div>
