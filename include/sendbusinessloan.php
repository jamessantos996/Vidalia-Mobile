...
$status = $_SESSION["CivilStatus"];

$bmonth = $_SESSION["birthmonth"];

$bday = $_SESSION["birthday"];

$byear = $_SESSION["birthyear"];

$bdate =  $bmonth. "-" . $bday . "-" . $byear;

$email = $_SESSION["loanemail"];

$cellphone = $_SESSION["ContactNumber"];

$landline = $_SESSION["LandlineNumber"];

$homeAddress = $_SESSION["homeAddress"];

$city = $_SESSION["City"];

$provincialAddress = $_SESSION["ProvincialAddress"];

$Residence = $_SESSION["ResidenceType"];

$usedfree = $_SESSION["UseFree"];

$typeOfResidence = $Residence . " " . $usedfree;

$typeOfResidenceYear = $_SESSION["ResidencesYear"];

$typeOfResidenceMonth = $_SESSION["ResidencesMonth"];

$presentCompany = $_SESSION["CompanyAddress"];

$jobPosition = $_SESSION["JobPosition"];

$employmentStatus = $_SESSION["EmploymentStatus"];

$currentSalary = $_SESSION["CurrentSalary"];

$employmentYear = $_SESSION["EmploymentYear"];

$employmentMonth = $_SESSION["EmploymentMonth"];

$businessname = $_SESSION["BusinessName"];

$businessnature= $_SESSION["businessNature"];

$businessmonth = $_SESSION["Businessmonth"];

$businessday = $_SESSION["Businessday"];

$businessyear= $_SESSION["BusinessYear"];

$businessdatestarted =  $businessmonth. "-" . $businessday . "-" . $businessyear;

$appliedLoanAmount = $_SESSION["LoanAmount"];
...
$mail->FromName = $fname . " " . $mname . " " . $lname ;
                ...
                $mail->addAddress( "jadecarlo@molavenet.com" , "Vidalia Lending Corp." );     // Add a recipient
                ...
                <table border='0' cellpadding='0' cellspacing='0' class='deviceWidth'>
                    ...
                    <tr>
                        <td width='190' height='40px'><p style='padding:5px 0;color:#DFA128; font-weight: 700;'><b>Applicant Business:</b></p> </td>
                    </tr>
                    <tr>
                        <td width='190' height='30px' style='padding-left:40px;'>Business name: </td>
                        <td>". $businessname."</td>
                    </tr>
                    <tr>
                        <td width='190' height='30px' style='padding-left:40px;'>Nature of Business: </td>
                        <td>".$businessnature."</td>
                    </tr>
                    <tr>
                        <td width='190' height='30px' style='padding-left:40px;'>Business Date Started: </td>
                        <td>".$businessdatestarted."</td>
                    </tr>
                    <tr>
