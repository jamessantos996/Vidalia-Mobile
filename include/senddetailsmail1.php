...
$responseData = json_decode($verifyResponse);
   ...
   // $address = $_POST['template-contactform-address'];
    ...
    $mail = new PhpMailer;
	$mail->CharSet = 'UTF-8';
    $mail->From = 'daniela@molavenet.com'; 
    $mail->addReplyTo( $email, $name );
    $mail->FromName = "Vidalia Lending Investment";
    $mail->addAddress( "daniela@molavenet.com" , "Vidalia Lending " );     // Add a recipient
    $mail->isHTML(true); // Set email format to HTML
    $mail->Subject = $subject;
	$first_half_message = "
		<div> 
			<p style='padding:10px 0;'><b>Submitted Details:</b></p>
		</div>
	...
	else if(($payout_method == "International Bank Wire") || ($payout_method == "Post Dated Check" && $_POST['template-location-bank'] == "International Bank"))
	{
		...
		$first_half_message = "
            ...
            <p style='padding:10px 0;'>Below are the details you have submitted on the online form</p>
			</div>
			<table border='0' cellpadding='0' cellspacing='0' class='deviceWidth'>
				<tr>
					<td width='190' height='30px'>Name: </td>
