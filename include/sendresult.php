...
// if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
	...
	$customerName			= $_POST['template-contactform-customer-name'];
	...
	if (isset($_POST['special_offer']) && $_POST['special_offer']) {
		...
		Here are the details you sent on the secure online form<br/>
		--------------------------------------------------------------------------------
		...
		*computation results are for estimation purposes only. These do not constitute an approval nor offer by Vidalia Lending.<br/>
		Total earnings quoted are indicative only. The rates used in this calculator are subject to change without notice.<br/>
		";
	...
	if($customerName == '' || $customerEmail == '' || $customerNumber == '' || $customerCurrency == '' || $customerAmountInvested == '' || $customerTerms == '' || $customerTermLabel == '' || $customerPlacementDate == '' || $customerReturnDate == '' || $customerInterestRate == '' || $customerTotalEarnings == '' || $customerTotalReturn == '')
	{
